...
export const movimientoStyles = StyleSheet.create({
    ...
    // Nuevo estilo para el contenedor de fecha
    movimientoFechaContainer: {
        flexDirection: "row",
        alignItems: "center",
    ...
    movimientoFecha: {
        color: "#8e8e93",
        fontSize: 11, // Un poco más pequeña para que sea sutil
        letterSpacing: 0.2,
    },
    // Opcional: Si quieres un ícono de reloj
    movimientoFechaIcon: {
        fontSize: 10,
        marginRight: 4,
        opacity: 0.6,
